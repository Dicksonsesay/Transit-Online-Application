...
export default function StudentTopBar({
  ...
  return (
    <header className="flex shrink-0 items-center justify-between gap-4 border-b border-[var(--dark-blue)]/15 bg-[var(--primary-yellow)] px-4 py-3 shadow-sm sm:px-6 sm:py-4 lg:px-8">
